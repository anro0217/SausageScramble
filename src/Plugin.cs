...
using System.IO;
using SausageScramble.Configuration;

namespace SausageScramble{
    ...
    public class Plugin : BaseUnityPlugin {
        ...
        private void Awake() {
            ...
            var SausageScramble = ModAssets.LoadAsset<EnemyType>("SausageScramble");
            var SausageScrambleTN = ModAssets.LoadAsset<TerminalNode>("SausageScrambleTN");
            var SausageScrambleTK = ModAssets.LoadAsset<TerminalKeyword>("SausageScrambleTK");

            // Optionally, we can list which levels we want to add our enemy to, while also specifying the spawn weight for each.
            /*
            var SausageScrambleLevelRarities = new Dictionary<Levels.LevelTypes, int> {
            ...
            var SausageScrambleCustomLevelRarities = new Dictionary<string, int> {
                {"EGyptLevel", 50},
            ...
            */
            ...
            NetworkPrefabs.RegisterNetworkPrefab(SausageScramble.enemyPrefab);
            ...
            Enemies.RegisterEnemy(SausageScramble, BoundConfig.SpawnWeight.Value, Levels.LevelTypes.All, SausageScrambleTN, SausageScrambleTK);
            // For using our rarity tables, we can use the following:
            // Enemies.RegisterEnemy(SausageScramble, SausageScrambleLevelRarities, SausageScrambleCustomLevelRarities, SausageScrambleTN, SausageScrambleTK);
